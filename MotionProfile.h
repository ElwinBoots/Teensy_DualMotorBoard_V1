...
public:	
	...
	void init();
	double stateCalculation( int input_status);
	double p2p_get_b( double t );
	double qref, vref, aref, jref;

	long REFstatus; 
	bool REFidir;
	float v, v_max, a_max, j_max, tstart, t1, t2, t3, Ts, rdelay;
	double REFiref, REFqmem;
  double p;
